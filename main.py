...
if not os.path.exists(MODEL_FILE):
    ...
    for train_index , test_index in split.split(housing , housing['income_cat']):
        housing.loc[test_index].drop('income_cat' , axis = 1).to_csv("test.csv" , index = False)  
    ...
    # Optimized tree parameters for compact model size (<100MB for GitHub & Streamlit Cloud)
    ...
    print("inference is done , results saved to output.csv")
